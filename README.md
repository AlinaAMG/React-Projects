...
- Data wordt opgehaald van een externe API.
- Unieke IDs worden gegenereerd met de `uuid` library.
- Modern React met **Hooks** (`useState`, `useEffect`).
- Icons gebruikt uit **React Icons**.
- Styling en responsive design met CSS.

## Tech Stack
- React
- React Hooks (`useState`, `useEffect`)
- React Icons
- UUID (voor unieke ID’s)
- Fetch API
- CSS voor styling en responsive design
